...
public:
	...
	Q_INVOKABLE QString exerciseName(const int row) const;
	...
	int exportToFile(const QString& filename, const bool writeHeader = true, const bool = true) const override;
