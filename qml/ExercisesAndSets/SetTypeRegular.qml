	...
	ColumnLayout {
		...
		RowLayout {
			...
			TPButton {
				...
				onClicked: {
					appDB.itemManager(tDayModel.mesoIdx()).copyRepsValueIntoOtherSets(exerciseIdx, setNumber);
					copyRepsButtonValue = "";
				}
			}
		} //RowLayout
		...
		RowLayout {
			...
			TPButton {
				...
				onClicked: {
					appDB.itemManager(tDayModel.mesoIdx()).copyWeightValueIntoOtherSets(exerciseIdx, setNumber);
					copyWeightButtonValue = "";
				}
			}
		} //RowLayout
