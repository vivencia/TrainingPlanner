...
create_users_db() {
    ...
    if sqlite3 -line $USERS_DB 'CREATE TABLE IF NOT EXISTS user_table (id INTEGER PRIMARY KEY, name TEXT, birthday INTEGER, sex TEXT, phone TEXT, email TEXT, social TEXT, role TEXT, coach_role TEXT, goal TEXT,  use_mode INTEGER DEFAULT 1, current_coach INTEGER, current_user INTEGER);' &>/dev/null; then
